...
export const content: DocContent = {
  ...
  blocks: [
    ...
    },
    {
      ...
      md: "Exploratory notes reference a `$AELIX` utility token, Alchemy RPC endpoints, wallets, and a Bankr launchpad, **none of these are built**, and none are part of the running equities desk. The on-chain vault + guardrails-as-code direction exists only as a **testnet-first, unaudited module** in `onchain/`: nothing is deployed to mainnet, and it stays gated behind legal/securities review plus official confirmation of non-equities availability. Do not treat any of it as a live product feature.",
    },
    {
      type: "prose",
