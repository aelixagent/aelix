...
claude mcp get robinhood-trading`,
    ...
    },
    {
      ...
      caption: "Exact lists live in `.claude/settings.json`. Option order tools are denied because the current access surface is equities-only.",
    },
    {
      type: "callout",
      tone: "info",
