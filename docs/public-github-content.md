...
AELIX access is gated. It is not financial advice. There is no track record, no public performance claim, and no production auto-trading desk.
...
- Request access flow for desk access/wallet pre-order
...
If you want early access, enter the next access wave and drop an EVM wallet for the wallet pre-order list.
...
No production auto-trading claims. No track record claims. Request access, unaudited, not investment advice.

The repo includes the desk architecture, docs, guardrails, JSONL audit logging, dashboard mirror, backtesting references, and the request access flow for desk access/wallet pre-order.
...
The repo includes the agent structure, docs, guardrails, audit logging, a read-only dashboard mirror, and on-chain vault module docs. It also now has a request access flow for the desk and wallet pre-order list.

Access is gated. It is not financial advice. There is no public track record and no production auto-trading claim.
